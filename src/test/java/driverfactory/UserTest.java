...
public class UserTest {
		...
		@Test
		  public void f() throws Throwable {
				 ...
				 String testcaseName=excel.getData("MasterTestCases", 3, 2);
				 String testcaseId_Mastertestcases=excel.getData("MasterTestCases", 3, 0);
				 ...
				 for(int j=1;j<=excel.rowCount(testcaseName);j++)
				  ...
				  if(fl.status.equalsIgnoreCase("PASS")) {
					  excel.setData2("MasterTestCases",3, 4, "PASS",testcaseName);
				  }else {
					  excel.setData2("MasterTestCases",3, 4, "FAIL",testcaseName);
				  }		
		  }
		}
